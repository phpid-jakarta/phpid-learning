...
<header class="header">
  <div class="hero-image">
    <div class="hero-text">
      <h1 class="animate__animated animate__bounce">PHPID-OL Kategori: {tag}</h1>
      <h3 class="animate__animated animate__bounce">{$allByTags.length} Materi</h3>
