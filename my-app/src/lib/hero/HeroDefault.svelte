...
<section data-section="hero" class="w-full">
  <div class="container mx-auto max-w-lg">
    <div class="flex flex-col gap-4 text-center px-8 py-16">
      <h1 class="text-gray-800 dark:text-white text-5xl">
      ...
      <div>
        <b class="text-xl text-gray-600 dark:text-gray-200">Daftar Webinar</b>
        <p class="text-gray-600 dark:text-gray-200">
          {dateRange}
        </p>
      </div>
